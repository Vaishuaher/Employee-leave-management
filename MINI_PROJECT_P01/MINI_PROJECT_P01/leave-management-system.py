...
class AdminClass:      # Dean
    ...
    def adminwindow(self):
        ...
        informationEmployee = Button(adminmainwindow, text = 'All Employee information', command = self.EmployeeAllInformationWindow, bd=12, relief=GROOVE, fg="black", bg="white",font=("Calibri", 36, "bold"), activebackground = "yellow")
        informationEmployee.pack(fill=X)

        LeaveListButton = Button(adminmainwindow, text = 'Leave approval list', command = self.leavelist, bd=12, relief=GROOVE, fg="black", bg="white",font=("Calibri", 36, "bold"), activebackground = "yellow")
        LeaveListButton.pack(fill=X)

        ApprovalButton = Button(adminmainwindow, text = 'Approve leave', command = self.LeaveApproval, bd=12, relief=GROOVE, fg="black", bg="white",font=("Calibri", 36, "bold"), activebackground = "yellow")
        ApprovalButton.pack(fill=X)

        LogoutBtn = Button(adminmainwindow, text = 'Logout', command = adminmainwindow.destroy, bd=12, relief=GROOVE, fg="red",bg="white",font=("Calibri", 36, "bold"), activebackground = "yellow")
...
class EmployeeClass:
    ...
    def EmployeeLoginWindow(self):
        ...
        informationEmployee = Button(LoginWindow, text = 'Employee information', command = self.EmployeeInformationWindow, bd=12, relief=GROOVE, fg="black", bg="white",font=("Calibri", 30, "bold"), activebackground = "yellow")
        informationEmployee.pack(fill=X)

        submit = Button(LoginWindow, text = 'Submit Leave', command = self.apply, bd=12, relief = GROOVE, fg = "black", bg = "white",font=("Calibri", 30, "bold"), activebackground = "yellow")
        submit.pack(fill=X)

        LeaveBalance = Button(LoginWindow, text= 'Leave Balance', command = self.balance, bd = 12, relief = GROOVE, fg="black", bg="white",font=("Calibri", 30, "bold"), activebackground = "yellow")
        LeaveBalance.pack(fill=X)

        LeaveApplicationStatus = Button(LoginWindow, text= 'Last leave status', command = self.EmployeeLeaveStatus, bd=12, relief=GROOVE, fg="black", bg="white",font=("Calibri", 30, "bold"), activebackground = "yellow")
        LeaveApplicationStatus.pack(fill=X)

        AllLeaveStatus = Button(LoginWindow, text='All leave status', command = self.EmployeeAllStatus, bd=12, relief=GROOVE, fg="black", bg="white",font=("Calibri", 30, "bold"), activebackground = "yellow")
        AllLeaveStatus.pack(fill=X)

        LogoutBtn = Button(LoginWindow, text = 'Logout', command = self.Employeelogout, bd=12, relief=GROOVE, fg="red", bg="white", font=("Calibri", 30, "bold"), activebackground = "yellow")
        LogoutBtn.pack(fill=X)
...
class update_info_class:
    ...
    def UpdateWindow(self):
        ...
        background_label = Label(UpdateWindow, bg="white")
        background_label.place(x=1, y=10, relwidth=1, relheight=1)
        ...
        updatename = Button(UpdateWindow, text = 'Update Name', command= self.update_name, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
...
AdminLgnBtn = Button(root, text='HR login',  bd=12, relief=GROOVE, fg="black", bg="white",font=("Calibri", 30, "bold"), command=obj5.HRLogin, activebackground = "white")
AdminLgnBtn.pack(fill=X)

AdminLgnBtn = Button(root, text='Dean login',  bd=12, relief=GROOVE, fg="black", bg="white",font=("Calibri", 30, "bold"), command=obj1.AdminLogin, activebackground = "white")
AdminLgnBtn.pack(fill=X)
    
EmployeeRegistration = Button(root, text='Employee registration', command = obj4.registration, bd=12, relief=GROOVE, fg="black", bg="white", font=("Calibri", 30, "bold"), activebackground = "white")
EmployeeRegistration.pack(fill=X)

LoginBtn = Button(root, text='Employee login', bd=12, relief=GROOVE, fg="black", bg="white", font=("Calibri", 30, "bold"), command=obj2.EmployeeLogin, activebackground = "white")
LoginBtn.pack(fill=X)

updatebutton = Button(root, text = "Update Information", bd = 12, relief=GROOVE, fg="black", bg="white", font=("Calibri", 30, "bold"), command = obj3.update_information, activebackground = "white")
updatebutton.pack(fill=X)

ExitBtn = Button(root, text='Exit', command=root.destroy, bd=12, relief=GROOVE, fg="red", bg="white", font=("Calibri", 30, "bold"), activebackground = "white")
ExitBtn.pack(fill=X)
